...
def AI_loop():
  ...
  if risks['wall'] == highest:
    ...
    #   turn left
      ...
      ai.turnLeft(1)
    # else: thrust    
    if speed <= 10 and (frontWall >= 200) and (left45Wall >= 200) and (right45Wall >= 200) and (right90Wall >= 200) and (left90Wall >= 200) and (left135Wall >= 50) and (right135Wall >= 35) and (backWall >= 35):
      ai.thrust(1)
